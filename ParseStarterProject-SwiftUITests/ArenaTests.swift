...
class ArenaTests: XCTestCase {
    ...
    func testExample() {
        ...
        app.buttons["Go Workout in Arena >"].tap()
        ...
        app.buttons["Create Arena >"].tap()
        app.buttons["Join Arena >"].tap()
        app.staticTexts["Friends Online Getting ProFit! :"].tap()
